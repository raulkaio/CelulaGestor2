...
public class RelatorioPessoasEncontroAdapter extends RecyclerView.Adapter<RelatorioPessoasEncontroAdapter.ViewHolder> {
    ...
    public RelatorioPessoasEncontroAdapter(List<Pessoa> l, Context c){
        context = c;
        mPessoaList = l;
    }

    @Override
    public RelatorioPessoasEncontroAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View itemView = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.lista_pessoas, viewGroup, false);
        return new RelatorioPessoasEncontroAdapter.ViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(RelatorioPessoasEncontroAdapter.ViewHolder holder, int position) {
